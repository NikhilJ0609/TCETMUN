  ...
  return (
    <PageContainer>
      ...
      <AgendaSection>
        <h2>AGENDA</h2>
        <Paragraph>
          Recognizing the challenges of connectivity and infrastructure in
          developing and least-developed countries in the context of e-commerce
          trade and implementing capacity-building strategies for inclusive
          trade participation. 🌐
        </Paragraph>
      </AgendaSection>
    </PageContainer>
